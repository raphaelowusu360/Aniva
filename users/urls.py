...
urlpatterns = [
    ...
    path(
        'friend-requests/',
        views.friend_requests_list,
        name='friend_requests_list'
    ),

    path(
        'send-friend/<int:user_id>/',
    ...
    path(
        'follow-back/<int:user_id>/',
        views.follow_back_user,
        name='follow_back_user'
    ),
    ...
    path(
        'groups/<int:group_id>/post/',
        views.add_group_post,
        name='add_group_post'
    ),

    path(
        'feedback/',
        views.feature_feedback,
    ...
    path(
        'groups/post/<int:post_id>/edit/',
        views.edit_group_post,
        name='edit_group_post'
    ),
