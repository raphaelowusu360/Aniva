...
class Profile(models.Model):
    ...
    favourite_anime = models.CharField(max_length=150, blank=True, null=True)
...
# Utility function to get a user's friends
def get_friends(user):
    ...
    for fr in accepted_requests:
        friends.append(fr.receiver if fr.sender == user else fr.sender)
    return friends
